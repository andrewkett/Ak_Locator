...
class DigiBrews_Locator_Model_Resource_Url extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        return Mage::getSingleton('digibrews_locator/location');
    }
    ...
    protected function _getLocations($locationIds, $storeId, $entityId, &$lastEntityId)
    {
        ...
        $select = $adapter->select()
            ...
            ->from(array('e' => $this->getTable('digibrews_locator/location')), array('entity_id'))
            // ->join(
            //     array('w' => $this->getTable('digibrews_locator/location_website')),
