...
class DigiBrews_Locator_Model_Resource_Setup extends Mage_Eav_Model_Entity_Setup {
    ...
    {
        $location           = (int)$this->getEntityTypeId('digibrews_locator_location');
        ...
        $attributes = $entities['digibrews_locator_location']['attributes'];
        ...
        if ($data) {
            $this->getConnection()->insertMultiple($this->getTable('digibrews_locator/form_attribute'), $data);
        }
    }
    ...
    public function getDefaultEntities() {
        return array(
            DigiBrews_Locator_Model_Location::ENTITY => array(
                'entity_model' => 'digibrews_locator/location',
                'table' => 'digibrews_locator/location', /* Maps to the config.xml > global > models > digibrews_locator_resource > entities > location */
                'attribute_model'                => 'digibrews_locator/attribute',
                'increment_model'                => 'eav/entity_increment_numeric',
                'additional_attribute_table'     => 'digibrews_locator/eav_attribute',
                'entity_attribute_collection'    => 'digibrews_locator/attribute_collection',
                'attributes' => array(
                    'title' => array(
                        'type' => 'varchar',
                        'label' => 'Title',
