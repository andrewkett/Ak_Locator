...
class DigiBrews_Locator_Model_Location_Url extends Varien_Object
{
     ...
     *
     * @param DigiBrews_Locator_Model_Location $location
     * @param array $params the URL route params
     * @return string
     */
    public function getUrlInStore(DigiBrews_Locator_Model_Location $location, $params = array())
    {
    ...
    {
        $urlKey = preg_replace('#[^0-9a-z]+#i', '-', Mage::helper('digibrews_locator/location_url')->format($str));
    ...
    //  * @return string
    //  */
    // public function getUrl(DigiBrews_Locator_Model_Location $location, $params = array())
    // {
    //     $routePath      = '';
    //     $routeParams    = $params;
    ...
    //         $categoryId = null;
    //     } else {
    //         $categoryId = $location->getCategoryId() && !$location->getDoNotUseCategoryId()
    //             ? $location->getCategoryId() : null;
    //     }
