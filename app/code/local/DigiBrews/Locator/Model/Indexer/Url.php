...
class DigiBrews_Locator_Model_Indexer_Url extends Mage_Index_Model_Indexer_Abstract
{
    /**
    ...
    {
        return Mage::helper('digibrews_locator')->__('Locator URL Rewrites');
    }
    ...
    {
        return Mage::helper('digibrews_locator')->__('Index location URL rewrites');
    }
    ...
    public function reindexAll()
    {
        ...
        $resourceModel = Mage::getResourceSingleton('digibrews_locator/url');
        $resourceModel->beginTransaction();
        try {
            Mage::getSingleton('digibrews_locator/url')->refreshRewrites();
