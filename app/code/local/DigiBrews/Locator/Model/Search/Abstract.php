 ...
 * @author     Andrew Kett
 */
abstract class DigiBrews_Locator_Model_Search_Abstract extends Mage_Core_Model_Abstract
{
    ...
    {
        return Mage::getModel('digibrews_locator/location')->getCollection()->addAttributeToFilter('is_enabled','1');
    }
