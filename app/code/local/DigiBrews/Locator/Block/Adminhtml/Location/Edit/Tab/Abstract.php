...
class Digibrews_Locator_Block_Adminhtml_Location_Edit_Tab_Abstract extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
        $locationForm = Mage::getModel('digibrews_locator/form');
    ...
    public function getLocation()
    {
        if(!isset($this->location)){
            ...
            $location = Mage::getModel('digibrews_locator/location');
    ...
    public function initForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend' => Mage::helper('digibrews_locator')->__($this->tabLabel)
        ));
