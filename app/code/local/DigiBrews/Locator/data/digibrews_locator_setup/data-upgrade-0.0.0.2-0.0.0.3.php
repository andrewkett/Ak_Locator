...
$lat = $installer->getAttribute('digibrews_locator_location','latitude_bak');
$long = $installer->getAttribute('digibrews_locator_location','longitude_bak');
...
$query = 'UPDATE `digibrews_locator_location_entity` AS `e`
	INNER JOIN `digibrews_locator_location_entity_varchar` AS `eav1`
		ON e.entity_id = eav1.entity_id and eav1.attribute_id = '.$latitudeAtt.'
	INNER JOIN `digibrews_locator_location_entity_varchar` AS `eav2`
