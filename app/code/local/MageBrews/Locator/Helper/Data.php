...
class MageBrews_Locator_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        Mage::throwException(Mage::helper('magebrews_locator')->__('Use helper with defined EAV entity'));
    }
    ...
    {
        return Mage::helper('magebrews_locator/location')->getAttributeFormOptions();
    }
    ...
    {
        return Mage::helper('magebrews_locator/location')->getUserDefinedAttributeCodes();
    }
