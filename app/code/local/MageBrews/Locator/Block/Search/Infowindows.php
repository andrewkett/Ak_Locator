...
class MageBrews_Locator_Block_Search_Infowindows extends Mage_Core_Block_Template
{
    protected $_location;
    ...
    public function getLocations(){
        ...
        if(!isset($this->_location)){
            ...
            $this->setLocations(Mage::getModel('magebrews_locator/location')->getCollection()->addAttributeToSelect('*')->addAttributeToFilter('entity_id', array('in' => $ids)));
        }
