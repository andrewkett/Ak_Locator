...
$installer->addAttribute(MageBrews_Locator_Model_Location::ENTITY, 'meta_title', array(
    'input'         => 'text',
    'type'          => 'varchar',
    'label'         => 'Meta Title',
    'backend'       => '',
...
$installer->addAttribute(MageBrews_Locator_Model_Location::ENTITY, 'meta_keywords', array(
    'input'         => 'text',
    'type'          => 'varchar',
    'label'         => 'Meta Keywords',
    'backend'       => '',
...
$installer->addAttribute(MageBrews_Locator_Model_Location::ENTITY, 'meta_description', array(
    'input'         => 'textarea',
    'type'          => 'text',
