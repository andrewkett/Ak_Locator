...
$installer->getConnection()
    ->addColumn($installer->getTable('magebrews_locator/location'), 'latitude', array(
...
$installer->getConnection()
    ->addColumn($installer->getTable('magebrews_locator/location'), 'longitude', array(
        'type'      => Varien_Db_Ddl_Table::TYPE_DECIMAL,
        'unsigned'  => false,
        'nullable'  => true,
        'scale'     => 12,
...
$installer->getConnection()
    ->addKey(
        $installer->getTable('magebrews_locator/location'),
        'LOCATION_LATITUDE',
        'latitude'
    );
