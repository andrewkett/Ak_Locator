...
class Ak_Locator_Model_Resource_Setup extends Mage_Eav_Model_Entity_Setup
{
    ...
    {
        $location           = (int)$this->getEntityTypeId('ak_locator_location');
        ...
        $attributes = $entities['ak_locator_location']['attributes'];
        ...
        if ($data) {
            $this->getConnection()->insertMultiple($this->getTable('ak_locator/form_attribute'), $data);
        }
    }
    ...
    public function getDefaultEntities()
    {
        return array(
            Ak_Locator_Model_Location::ENTITY => array(
                ...
                'entity_attribute_collection'    => 'ak_locator/attribute_collection',
                'attributes' => array(
                    'title' => array(
                        'type' => 'varchar',
                        'label' => 'Title',
